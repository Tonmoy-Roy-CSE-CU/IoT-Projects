...
File includes:
 |
 |- KY-019 5V Relay Module.fzpz		//Fritzing Custom Part
 |
...
Changelog:
  ...
  Oct-2020
    -Fix PCB holes. (Thanks to vanepp on forum.fritzing.org)
    -Fix PCB size.
    -Fix copper layers on PCB.
    -Fix connection ID on SVG elements for breadboard, schematic and PCB views.
